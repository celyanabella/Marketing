...
function idf_init_set_defaults() {
	...
	$version_array = array(
		'ignitiondeck-crowdfunding/ignitiondeck.php' => '1.6.5',
		'idcommerce/idcommerce.php' => '1.8.2'
	);
...
function idf_prepare_scripts() {
	...
	wp_localize_script('idf', 'idf_date_format', idf_date_format());
